...
/**
 * <code>UI</code> delegate for the <code>RangeSlider</code> component with Metal L&amp;F. It paints two thumbs, one for
 * the lower value and one for the upper value.
 *
...
public class MetalRangeSliderUI extends MetalSliderUI {
    ...
    protected TrackListener createTrackListener(final JSlider slider) {
        return new MetalRangeSliderUI.RangeTrackListener();
    }
    ...
    protected ChangeListener createChangeListener(final JSlider slider) {
        return new MetalRangeSliderUI.ChangeHandler();
    }
    ...
    private void paintUpperThumb(final Graphics g) {
        final Rectangle tempRect = super.thumbRect;
        super.thumbRect = upperThumbRect;
        super.paintThumb(g);
        super.thumbRect = tempRect;
    }
